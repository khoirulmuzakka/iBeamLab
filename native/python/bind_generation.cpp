...
#undef DETECTOR_TARGET
    ...
    py::class_<GenerationConfig>(m, "GenerationConfig")
        ...
        .def("open_parameter_names", &GenerationConfig::openParameterNames)
    ...
    py::class_<GenerationOptions>(m, "GenerationOptions")
        ...
        .def_readwrite("sampler", &GenerationOptions::sampler)
        .def_readwrite("sampler_version", &GenerationOptions::samplerVersion)
        .def_readwrite("sampling_config_toml", &GenerationOptions::samplingConfigToml)
        ...
        .def(
            ...
            [](DataGenerator &self, const std::filesystem::path &path,
               ...
               const GenerationOptions &options, py::object callback) {
                ...
                return self.generate(path, parameterRows, options, std::move(progress));
            },
            py::arg("path"), py::arg("parameter_rows"), py::arg("options"),
